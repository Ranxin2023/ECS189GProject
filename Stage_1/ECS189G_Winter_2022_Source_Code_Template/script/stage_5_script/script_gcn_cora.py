from Stage_1.ECS189G_Winter_2022_Source_Code_Template.code.stage_5_code.Dataset_Loader import DatasetLoader
from Stage_1.ECS189G_Winter_2022_Source_Code_Template.code.stage_5_code.Method_GCN import MethodGCN
from Stage_1.ECS189G_Winter_2022_Source_Code_Template.code.stage_5_code.Result_Saver import ResultSaver
from Stage_1.ECS189G_Winter_2022_Source_Code_Template.code.stage_5_code.Setting_Train_Test_Split import SettingGCN
...
if 1:
    ...
    epoch = [i for i in range(2000) if i % 10 == 0]
    print(epoch)
    #print(method_obj.loss_set)          ###
    plt.plot(epoch, method_obj.loss_set, color='green', linestyle='dashed', linewidth=3, marker='o', markerfacecolor='blue', markersize=12)
