...
from Stage_1.ECS189G_Winter_2022_Source_Code_Template.code.stage_4_code.textGenerator.Method_CNN import MethodCNN
from Stage_1.ECS189G_Winter_2022_Source_Code_Template.code.stage_4_code.textGenerator.Result_Saver import ResultSaver
from Stage_1.ECS189G_Winter_2022_Source_Code_Template.code.stage_4_code.textGenerator.Setting_Train_Test_Split import SettingCNN
from Stage_1.ECS189G_Winter_2022_Source_Code_Template.code.stage_4_code.textGenerator.Evaluate_Accuracy import EvaluateAccuracy
import numpy as np
import torch
...
if 1:
    ...
    data_obj.dataset_source_folder_path = '../../data/stage_4_data/text_generation/'                # FINISHED TODO: change the dataset folder path
