...
from Stage_1.ECS189G_Winter_2022_Source_Code_Template.code.stage_1_code.Evaluate_Accuracy import EvaluateAccuracy
import torch
...
class MethodMLP(BaseMethod, nn.Module):
    ...
    def train(self, x, y):
        ...
        for epoch in range(self.max_epoch):  # you can do an early stop if self.max_epoch is too much...
            ...
            if epoch%100 == 0:
                accuracy_evaluator.data = {'true_y': y_true, 'pred_y': y_pred.max(1)[1]} #TODO: ????????1?[1]???
