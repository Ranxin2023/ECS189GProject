...
# Layer reference: https://github.com/tkipf/pygcn/blob/master/pygcn/layers.py
...
class MethodGCN(BaseMethod, nn.Module):
    ...
    # model reference: https://github.com/tkipf/pygcn/blob/master/pygcn/models.py
    def __init__(self, mName, mDescription):
        BaseMethod.__init__(self, mName, mDescription)
        nn.Module.__init__(self)
        self.gc1 = GraphConvolution(500, 256)
        self.gc2 = GraphConvolution(256, 128)
        self.gc3 = GraphConvolution(128, 64)
        self.gc4 = GraphConvolution(64,3)
        self.dropout = 0.15
